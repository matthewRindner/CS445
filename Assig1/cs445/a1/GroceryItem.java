...
/**
 * GroceryItem represents a single item on a shopping list. Its quantity is
...
public class GroceryItem {
     ...
     */
    public void setQuantity(int n) throws IllegalArgumentException {
        if (n < 1) throw new IllegalArgumentException("Quantity less than 1");
        quantity = n;
    }
